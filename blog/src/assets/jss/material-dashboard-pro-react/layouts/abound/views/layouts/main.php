...
// );
	...
	<?php  
	 ...
	 // Yii::app()->clientScript->registerPackage('easyui');
    ?>
 ...
 $basePath = Yii::app()->baseUrl."/widgets/jquery-easyui/";
    ...
    $cs->registerScriptFile($basePath."extension/"."datagrid-detailview.js");
    $cs->registerScriptFile($basePath."locale/easyui-lang-vi.js");
 //   $cs->registerScriptFile($basePath."extension/datagrid-filter.js");
	?>
